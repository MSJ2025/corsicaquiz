...
class ClassicFauneQuizScreen extends StatefulWidget {
  @override
  _ClassicFauneQuizScreenState createState() => _ClassicFauneQuizScreenState();
}

class _ClassicFauneQuizScreenState extends State<ClassicFauneQuizScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    FirebaseAnalytics.instance.logEvent(name: 'classic_faune_quiz_started');
  }
