...
class ClassicHistoireQuizScreen extends StatefulWidget {
  @override
  _ClassicHistoireQuizScreenState createState() => _ClassicHistoireQuizScreenState();
}

class _ClassicHistoireQuizScreenState extends State<ClassicHistoireQuizScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    FirebaseAnalytics.instance.logEvent(name: 'classic_histoire_quiz_started');
    _player = AudioPlayer();
